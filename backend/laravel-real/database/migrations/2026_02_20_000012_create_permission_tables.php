...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($tableNames['model_has_permissions'] ?? 'model_has_permissions', function (Blueprint $table) use ($tableNames, $pivotPermission, $modelMorphKey) {
        ...
        Schema::create($tableNames['model_has_roles'] ?? 'model_has_roles', function (Blueprint $table) use ($tableNames, $pivotRole, $modelMorphKey) {
